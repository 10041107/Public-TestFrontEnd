      ...
      <div className="flex flex-col items-center p-4">
        ...
        {loading ? <p>로딩 중...</p> : (
          <form onSubmit={handleSubmit} className="w-full max-w-md">
            <div className="mb-4">
              <label htmlFor="userName" className="block text-gray-700">이름:</label>
              <input
                id="userName"
                name="userName"
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="profileImage" className="block text-gray-700">프로필 이미지:</label>
              {publicId && (
                <CldImage
                  src={publicId}
                  width={270}
              ...
              >
                {({ open }) => (
                  <button type="button" onClick={() => open()} className="block w-full px-4 py-2 text-white bg-neutral-500 ring-neutral-300 hover:bg-neutral-400">
                    프로필 이미지 업로드
                  </button>
                )}
              </CldUploadWidget>
