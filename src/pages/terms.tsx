...
const Terms: React.FC = () => {
  ...
  제 1 조 (목적)
  본 약관은 팀 비트코딩이 운영하는 웹 사이트의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
  ...
  2) 개인정보 수집방법: 
  홈페이지(회원 가입), 서면 양식, 전화/팩스를 통한 회원 가입
  ...
  이 개인정보 취급방침은 2024년 05월 23일부터 적용됩니다.
      ...
      <div className="text-center">
        ...
        <div className="flex flex-col items-center w-full gap-4 max-w-7xl xl:max-w-2xl lg:max-w-lg md:max-w-md sm:max-w-md ">
          <div className="flex flex-col h-64 p-4 border">
            ...
            <p className="overflow-y-auto text-sm whitespace-pre-line ">{dummyText1}</p>
          </div>
          <div className="flex flex-col h-64 p-4 overflow-y-auto border">
            <h2 className="mt-1 mb-3 text-xl font-bold">개인정보 처리 방침</h2>
            <p className="overflow-y-auto text-sm whitespace-pre-line ">{dummyText2}</p>
          </div>
        </div>
        <div className="mt-4">
