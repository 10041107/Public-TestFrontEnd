        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            >
              ...
              <hr className="border-1 my-5 w-full"/>
              
              {resultData && ( 
                <div className="card p-4 shadow-lg my-3 rounded-md w-11/12 flex flex-col items-center border-2">
                  <h2 className="text-2xl font-semibold text-Neutral-600 my-3 ">통합 점수</h2>
                  ...
                  <p className="text-Neutral-500 my-4 text-xs w-8/12">
                  ...
                  <hr className="border-neutral-200 border-1 w-1/3"/>
                  <hr className="border-neutral-200 border-1 w-full"/>
                  <div className="mt-4 max-w-4xl flex justify-center w-11/12" style={{ height: '400px' }}>
...
<h2 className="text-2xl font-semibold text-Neutral-600 mt-8">세부 정산 결과</h2>
<hr className="border-neutral-200 border-1 w-1/2" />
{resultData && (
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-4 mt-4 w-11/12">
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">외교/안보 점수</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
        국가 안보와 외교 정책에 대해 어떤 입장을 가지고 있는지를 평가합니다.
      </h3>
      <p className="text-Neutral-500 my-4 text-xs w-8/12 text-center">
      ...
      <hr className="border-neutral-200 border-1 w-1/3" />
      <hr className="border-neutral-200 border-1 w-1/2" />
      <div className="mt-4 max-w-4xl flex justify-center w-11/12" style={{ height: '55px' }}>
        <Bar data={createHorizontalBarData(animatedScores.securityScore)} options={options2} />
      </div>
    </div>

    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">사회 점수</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
    ...
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">경제 점수</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
    ...
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">법/제도 점수</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
...
<h2 className="text-2xl font-semibold text-Neutral-600 mt-8">기타 평가 결과</h2>
<hr className="border-neutral-200 border-1 w-1/2" />

{resultData && resultData.analysisResults && (
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-4 mt-4 w-11/12">
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">관심도</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
        사회적 이슈에 대해 어떤 입장을 가지고 있는지를 평가합니다.
      </h3>
      <p className="text-Neutral-500 my-4 text-xs w-8/12 text-center">
    ...
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">참여도</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
        사회적 이슈에 대해 어떤 입장을 가지고 있는지를 평가합니다.
      </h3>
      <p className="text-Neutral-500 my-4 text-xs w-8/12 text-center">
    ...
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-Neutral-600 my-3">일관성</h2>
      <h3 className="my-2 text-sm text-Neutral-700 text-center w-8/12">
        사회적 이슈에 대해 어떤 입장을 가지고 있는지를 평가합니다.
      </h3>
      <p className="text-Neutral-500 my-4 text-xs w-8/12 text-center">
    ...
    <div className="card p-4 shadow-lg rounded-md border-2 flex flex-col items-center">
                  <motion.div
                    ...
                    >
                      <div className="m-5 grid w-9/12 items-center place-items-center">
                        <button onClick={handleResetTest} className="my-2 flex items-center justify-center whitespace-nowrap p-2 m-1 text-white bg-neutral-400 rounded w-52">
                          <RiArrowGoForwardFill  className="w-5 text-white lg:w-5 mr-2" />
                          테스트 다시 해보기
                        </button>

                        <button onClick={() => handleCopyClipboard(window.location.href)} className="my-2 flex items-center justify-center whitespace-nowrap p-2 m-1 text-white bg-neutral-500 rounded w-52">
                          <RiMessage2Fill  className="w-5 text-white lg:w-5 mr-2" />
                          공유하기
                        </button>

                        <button onClick={() => router.push('/')} className="my-2 flex items-center justify-center whitespace-nowrap p-2 m-1 text-white bg-neutral-600 rounded w-52">
                          <RiDownload2Line className="w-5 text-white lg:w-5 mr-2" />
                          홈으로 돌아가기
                        </button>

                        <button onClick={handleDownloadImage} className="my-2 flex items-center justify-center whitespace-nowrap p-2 m-1 text-white bg-neutral-700 rounded w-52">
                          <RiChatDownloadLine  className="w-5 text-white lg:w-5 mr-2" />
                          이미지 저장하기
                        </button>
                      </div>
                    </motion.div>
